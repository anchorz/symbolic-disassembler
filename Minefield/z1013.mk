...
obj/z1013/$(OUT).z80: obj/z1013/z80_header.rel $(addsuffix .rel,$(addprefix obj/z1013/,$(OBJECTS)))
	$(LINK) $(SDLD_OPT) -b _CODE=0x00e0 -i $(@:z80=ihx) $^
	$(OBJCOPY) -Iihex -Obinary $(@:z80=ihx) "$@"
	dd if="$@" of=obj/z1013/padded.tmp bs=32 conv=sync
	mv obj/z1013/padded.tmp "$@"
